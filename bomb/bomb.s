...
0000000000401204 <fun7>:
  ...
  40120b:	74 2b                	je     401238 <fun7+0x34> /* rdi == 0, 0x38 */
  40120d:	8b 17                	mov    (%rdi),%edx
  40120f:	39 f2                	cmp    %esi,%edx
  401211:	7e 0d                	jle    401220 <fun7+0x1c> /* (rdi) <= input, 0x20 */
  401213:	48 8b 7f 08          	mov    0x8(%rdi),%rdi
  401217:	e8 e8 ff ff ff       	callq  401204 <fun7>
  40121c:	01 c0                	add    %eax,%eax
  40121e:	eb 1d                	jmp    40123d <fun7+0x39> /* 0x3d */

  401220:	b8 00 00 00 00       	mov    $0x0,%eax
  401225:	39 f2                	cmp    %esi,%edx
  401227:	74 14                	je     40123d <fun7+0x39> /* (rdi) == input, 3d */
...
0000000000401242 <secret_phase>:
  ...
  401265:	76 05                	jbe    40126c <secret_phase+0x2a> /*input > 1001,explode */
